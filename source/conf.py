...
# -*- coding: utf-8 -*-
#
# FEC-2017 documentation build configuration file, created by
...
# pixels large.
html_favicon = "img/favicon/GeoPython_favicon.ico"
...
htmlhelp_basename = 'Geo-Python-2017doc'
...
latex_documents = [
  (master_doc, 'Geo-Python-2017.tex', 'Geo-Python-2017 Documentation',
   'HT-DW', 'manual'),
]
...
man_pages = [
    (master_doc, 'Geo-Python-2017', 'Geo-Python-2017 Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Geo-Python-2017', 'Geo-Python-2017 Documentation',
   author, 'Geo-Python-2017', 'One line description of project.',
   'Miscellaneous'),
]
...
def setup(app):
    app.add_stylesheet('geo-python.css')