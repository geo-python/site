...
.. note:: **When using the CSC Notebooks for the first time, you need to join the group created for this course:**
    ...
    After joining the group, you should be able to view the course environments called `Geopython 2026` at the top of the Application list.
...
All enrolled students have received an invite link to the `GeoPython-2026` workspace at the start of the course.
