...
# Notice: Write these lines into a separate script called ``weather_analysis.py`` because we re-use it later.
...
# Let's see how it works. Here, we will use a specific Python command called ``break`` can be used to stop the iteration right after the first loop. 
